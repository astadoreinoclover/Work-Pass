...
const VoltarFuncionarios: React.FC = () => {
    ...
    return (
        <Pressable
            onPress={() => { navigation.navigate('Funcionarios') }} // Navega para o perfil
            onHoverIn={() => {
                if (isLargeScreen) {
                    setIsHovered(true);
                    animateButton(true);
...
export default VoltarFuncionarios;
